...
const helpContents: { [key: string]: HelpContent } = {
  '훈련 세션': {
    ...
    mythVsFact: '텍스트를 따라 입력하는 훈련은 읽기와 쓰기의 동기화를 통해 집중력을 향상시키고, 내면의 목소리를 최적화하는 효과적인 방법입니다. 이는 작업 기억의 음운 고리를 효율적으로 활용하면서도 시각적 처리 능력을 향상시킵니다.',
    motivation: '텍스트를 따라 입력하는 훈련은 읽기와 쓰기의 동기화를 통해 집중력을 향상시키고, 내면의 목소리를 최적화하는 효과적인 방법입니다. 이는 작업 기억의 음운 고리를 효율적으로 활용하면서도 시각적 처리 능력을 향상시킵니다.',
    llmPrompt: '텍스트를 따라 입력하는 훈련은 읽기와 쓰기의 동기화를 통해 집중력을 향상시키고, 내면의 목소리를 최적화하는 효과적인 방법입니다. 이는 작업 기억의 음운 고리를 효율적으로 활용하면서도 시각적 처리 능력을 향상시킵니다.'
  },
  '읽기 패턴 진단': {
    title: '읽기 패턴 진단',
    ...
    mythVsFact: '인지과학 연구에 따르면, 대부분의 성인 독자는 분당 150-250단어(WPM) 수준에서 읽기 속도가 제한됩니다. 이는 내면의 목소리(묵독)가 실제 말하기 속도와 밀접하게 연결되어 있기 때문입니다. 키스 레이너의 연구는 숙련된 독자들조차 속발음을 한다는 사실을 밝혔으며, 단지 더 빨리 속발음을 할 뿐이라고 합니다.',
    motivation: '인지과학 연구에 따르면, 대부분의 성인 독자는 분당 150-250단어(WPM) 수준에서 읽기 속도가 제한됩니다. 이는 내면의 목소리(묵독)가 실제 말하기 속도와 밀접하게 연결되어 있기 때문입니다. 키스 레이너의 연구는 숙련된 독자들조차 속발음을 한다는 사실을 밝혔으며, 단지 더 빨리 속발음을 할 뿐이라고 합니다.',
    llmPrompt: '인지과학 연구에 따르면, 대부분의 성인 독자는 분당 150-250단어(WPM) 수준에서 읽기 속도가 제한됩니다. 이는 내면의 목소리(묵독)가 실제 말하기 속도와 밀접하게 연결되어 있기 때문입니다. 키스 레이너의 연구는 숙련된 독자들조차 속발음을 한다는 사실을 밝혔으며, 단지 더 빨리 속발음을 할 뿐이라고 합니다.'
  },
  '페이서 훈련': {
    title: '페이서 훈련',
    ...
    mythVsFact: '페이서 훈련은 안구 운동을 최적화하고 회귀(regression)를 줄이는 효과적인 방법입니다. 엘리자베스 쇼터의 연구에 따르면, 독서의 병목 현상은 눈의 움직임(전체 독서 시간의 약 10% 차지)이 아니라, 단어를 인식하고 문장 구조를 분석하는 언어 처리 과정에 있습니다. 페이서는 시각적 주의를 집중시키고 일정한 리듬을 만들어줍니다.',
    motivation: '페이서 훈련은 안구 운동을 최적화하고 회귀(regression)를 줄이는 효과적인 방법입니다. 엘리자베스 쇼터의 연구에 따르면, 독서의 병목 현상은 눈의 움직임(전체 독서 시간의 약 10% 차지)이 아니라, 단어를 인식하고 문장 구조를 분석하는 언어 처리 과정에 있습니다. 페이서는 시각적 주의를 집중시키고 일정한 리듬을 만들어줍니다.',
    llmPrompt: '페이서 훈련은 안구 운동을 최적화하고 회귀(regression)를 줄이는 효과적인 방법입니다. 엘리자베스 쇼터의 연구에 따르면, 독서의 병목 현상은 눈의 움직임(전체 독서 시간의 약 10% 차지)이 아니라, 단어를 인식하고 문장 구조를 분석하는 언어 처리 과정에 있습니다. 페이서는 시각적 주의를 집중시키고 일정한 리듬을 만들어줍니다.'
  },
  '의미 단위 읽기': {
    title: '의미 단위 읽기',
    ...
    mythVsFact: '청킹(Chunking)은 의미 단위로 여러 단어를 한 번에 처리하는 기술입니다. 이는 음운 병목 현상을 극복하는 핵심 방법으로, 처리해야 할 "소리 단위"의 수를 줄여줍니다. 배들리-히치 모델의 음운 고리 이론에 따르면, 작업 기억에서 정보를 더 효율적으로 처리할 수 있게 됩니다.',
    motivation: '청킹(Chunking)은 의미 단위로 여러 단어를 한 번에 처리하는 기술입니다. 이는 음운 병목 현상을 극복하는 핵심 방법으로, 처리해야 할 "소리 단위"의 수를 줄여줍니다. 배들리-히치 모델의 음운 고리 이론에 따르면, 작업 기억에서 정보를 더 효율적으로 처리할 수 있게 됩니다.',
    llmPrompt: '청킹(Chunking)은 의미 단위로 여러 단어를 한 번에 처리하는 기술입니다. 이는 음운 병목 현상을 극복하는 핵심 방법으로, 처리해야 할 "소리 단위"의 수를 줄여줍니다. 배들리-히치 모델의 음운 고리 이론에 따르면, 작업 기억에서 정보를 더 효율적으로 처리할 수 있게 됩니다.'
  },
  '인지 병목 현상 이해': {
    title: '인지 병목 현상 이해',
    ...
    difficulty: '중급',
    icon: <Brain className="h-5 w-5" />,
    mythVsFact: '음운 병목 현상(phonological bottleneck)은 내면의 목소리가 단어를 처리하는 속도가 실제 말하기 속도와 밀접하게 연결되어 있어 발생합니다. 대부분의 사람들에게 이는 분당 150-250 단어(WPM) 수준입니다. 이는 독서 속도가 분당 약 200-300 단어를 넘기 어렵다는 것을 의미합니다.',
    motivation: '음운 병목 현상(phonological bottleneck)은 내면의 목소리가 단어를 처리하는 속도가 실제 말하기 속도와 밀접하게 연결되어 있어 발생합니다. 대부분의 사람들에게 이는 분당 150-250 단어(WPM) 수준입니다. 이는 독서 속도가 분당 약 200-300 단어를 넘기 어렵다는 것을 의미합니다.',
    llmPrompt: '음운 병목 현상(phonological bottleneck)은 내면의 목소리가 단어를 처리하는 속도가 실제 말하기 속도와 밀접하게 연결되어 있어 발생합니다. 대부분의 사람들에게 이는 분당 150-250 단어(WPM) 수준입니다. 이는 독서 속도가 분당 약 200-300 단어를 넘기 어렵다는 것을 의미합니다.'
  },
  '시각화 훈련': {
    title: '시각화 훈련',
    ...
    difficulty: '중급',
    icon: <Eye className="h-5 w-5" />,
    mythVsFact: '시각화 훈련은 인지 처리 과정을 음운 고리에서 시각공간 스케치패드(visuospatial sketchpad)로 전환시킵니다. 이는 더 깊고 직관적인 의미 기반 이해를 촉진합니다. 연구에 따르면, 시각적 이미지를 활용한 학습은 기억과 이해에 더 효과적입니다.',
    motivation: '시각화 훈련은 인지 처리 과정을 음운 고리에서 시각공간 스케치패드(visuospatial sketchpad)로 전환시킵니다. 이는 더 깊고 직관적인 의미 기반 이해를 촉진합니다. 연구에 따르면, 시각적 이미지를 활용한 학습은 기억과 이해에 더 효과적입니다.',
    llmPrompt: '시각화 훈련은 인지 처리 과정을 음운 고리에서 시각공간 스케치패드(visuospatial sketchpad)로 전환시킵니다. 이는 더 깊고 직관적인 의미 기반 이해를 촉진합니다. 연구에 따르면, 시각적 이미지를 활용한 학습은 기억과 이해에 더 효과적입니다.'
  },
  '적응적 속도 훈련': {
    title: '적응적 속도 훈련',
    ...
    mythVsFact: '숙련된 독자는 텍스트의 밀도와 목적에 따라 읽기 속도와 방법을 조절합니다. 이는 독서의 유연성(reading flexibility)이라고 불립니다. 연구에 따르면, 대부분의 성인 독자가 완전한 이해력을 유지하며 읽을 수 있는 속도의 상한선은 분당 500-600 단어(WPM) 수준입니다.',
    motivation: '숙련된 독자는 텍스트의 밀도와 목적에 따라 읽기 속도와 방법을 조절합니다. 이는 독서의 유연성(reading flexibility)이라고 불립니다. 연구에 따르면, 대부분의 성인 독자가 완전한 이해력을 유지하며 읽을 수 있는 속도의 상한선은 분당 500-600 단어(WPM) 수준입니다.',
    llmPrompt: '숙련된 독자는 텍스트의 밀도와 목적에 따라 읽기 속도와 방법을 조절합니다. 이는 독서의 유연성(reading flexibility)이라고 불립니다. 연구에 따르면, 대부분의 성인 독자가 완전한 이해력을 유지하며 읽을 수 있는 속도의 상한선은 분당 500-600 단어(WPM) 수준입니다.'
  },
  '빠른 시작 훈련': {
    title: '빠른 시작 훈련',
    ...
    difficulty: '초급-중급',
    icon: <BookOpen className="h-5 w-5" />,
    mythVsFact: '빠른 시작 훈련은 인지과학 연구를 바탕으로 설계된 체계적인 프로그램입니다. 이 훈련은 읽기 과정에서 발생하는 자연스러운 인지 현상을 이해하고 최적화하는 것이 목표입니다. 키스 레이너와 엘리자베스 쇼터의 연구를 바탕으로, 이해력과 속도의 균형을 찾는 것이 핵심입니다.',
    motivation: '빠른 시작 훈련은 인지과학 연구를 바탕으로 설계된 체계적인 프로그램입니다. 이 훈련은 읽기 과정에서 발생하는 자연스러운 인지 현상을 이해하고 최적화하는 것이 목표입니다. 키스 레이너와 엘리자베스 쇼터의 연구를 바탕으로, 이해력과 속도의 균형을 찾는 것이 핵심입니다.',
    llmPrompt: '빠른 시작 훈련은 인지과학 연구를 바탕으로 설계된 체계적인 프로그램입니다. 이 훈련은 읽기 과정에서 발생하는 자연스러운 인지 현상을 이해하고 최적화하는 것이 목표입니다. 키스 레이너와 엘리자베스 쇼터의 연구를 바탕으로, 이해력과 속도의 균형을 찾는 것이 핵심입니다.'
  },
  '맞춤형 훈련': {
    title: '맞춤형 훈련',
    ...
    difficulty: '맞춤형',
    icon: <Target className="h-5 w-5" />,
    mythVsFact: '맞춤형 훈련은 개인의 현재 읽기 능력과 목표를 고려하여 설계됩니다. 배들리-히치 모델의 작업 기억 이론을 바탕으로, 개인의 음운 작업 기억력과 시각적 처리 능력을 종합적으로 평가하여 최적의 훈련 계획을 수립합니다.',
    motivation: '맞춤형 훈련은 개인의 현재 읽기 능력과 목표를 고려하여 설계됩니다. 배들리-히치 모델의 작업 기억 이론을 바탕으로, 개인의 음운 작업 기억력과 시각적 처리 능력을 종합적으로 평가하여 최적의 훈련 계획을 수립합니다.',
    llmPrompt: '맞춤형 훈련은 개인의 현재 읽기 능력과 목표를 고려하여 설계됩니다. 배들리-히치 모델의 작업 기억 이론을 바탕으로, 개인의 음운 작업 기억력과 시각적 처리 능력을 종합적으로 평가하여 최적의 훈련 계획을 수립합니다.'
  },
  '속도 향상 훈련': {
    title: '속도 향상 훈련',
    ...
    mythVsFact: '속도 향상 훈련은 음운 병목 현상을 극복하고 시각적 처리 능력을 강화하는 고급 훈련입니다. 엘리자베스 쇼터의 연구에 따르면, 독서의 병목 현상은 눈의 움직임이 아니라 언어 처리 과정에 있습니다. 이 훈련은 시각공간 스케치패드를 활용하여 더 효율적인 정보 처리를 목표로 합니다.',
    motivation: '속도 향상 훈련은 음운 병목 현상을 극복하고 시각적 처리 능력을 강화하는 고급 훈련입니다. 엘리자베스 쇼터의 연구에 따르면, 독서의 병목 현상은 눈의 움직임이 아니라 언어 처리 과정에 있습니다. 이 훈련은 시각공간 스케치패드를 활용하여 더 효율적인 정보 처리를 목표로 합니다.',
    llmPrompt: '속도 향상 훈련은 음운 병목 현상을 극복하고 시각적 처리 능력을 강화하는 고급 훈련입니다. 엘리자베스 쇼터의 연구에 따르면, 독서의 병목 현상은 눈의 움직임이 아니라 언어 처리 과정에 있습니다. 이 훈련은 시각공간 스케치패드를 활용하여 더 효율적인 정보 처리를 목표로 합니다.'
  }
};
